...
<div class="pt-20 min-h-screen bg-gray-50">
    ...
    <div class="bg-white py-20">
        <div class="container mx-auto px-6">
            <h2 class="text-4xl font-bold text-center mb-16 text-gray-800">{{ __('messages.benefits') }} {{ __('messages.for_individual_customers') }}</h2>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-bold mb-4 text-gray-800">{{ __('messages.save_time') }}</h3>
                    <p class="text-gray-600">{{ __('messages.save_time_desc') }}</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-bold mb-4 text-gray-800">{{ __('messages.reliable') }}</h3>
                    <p class="text-gray-600">{{ __('messages.reliable_desc') }}</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-bold mb-4 text-gray-800">{{ __('messages.fast') }}</h3>
                    <p class="text-gray-600">{{ __('messages.fast_desc') }}</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-bold mb-4 text-gray-800">{{ __('messages.dedicated_support') }}</h3>
                    <p class="text-gray-600">{{ __('messages.dedicated_support_desc') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-20">
        <div class="container mx-auto px-6">
            <h2 class="text-4xl font-bold text-center mb-16 text-gray-800">{{ __('messages.how_to_use_service') }}</h2>
            ...
            <div class="grid md:grid-cols-4 gap-8">
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-bold mb-4 text-gray-800">{{ __('messages.place_order') }}</h3>
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">{{ __('messages.track_realtime') }}</p>
                </div>
