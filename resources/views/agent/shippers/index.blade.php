...
@section('title', 'Shippers Management - Agent')
...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-green-500 to-teal-600 rounded-lg shadow-lg p-6 text-white">
        <h1 class="text-2xl font-bold mb-2">Shippers Management</h1>
        <p class="text-green-100">View and manage shippers in your area</p>
    </div>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">Total shippers</dt>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            ...
            <input type="text" id="searchInput" class="border rounded-lg px-3 py-2" placeholder="Search name, email...">
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">Add new shipper</h3>
            </div>
...
async function loadShippers(page = 1) {
    try {
        ...
        document.getElementById('shippersTableBody').innerHTML = `
            <tr><td colspan="6" class="text-center text-red-500 py-4">Error loading data: ${error.message}</td></tr>
        `;
    }
}
...
async function loadShipperStats() {
    try {
        ...
        if (shippers.error) {
            console.error('Error loading stats:', shippers.error);
            return;
        }
...
function renderShippersTable(shippers) {
    ...
    if (shippers.length === 0) {
        tbody.innerHTML = `
            <tr><td colspan="6" class="text-center text-gray-500 py-8">No shippers</td></tr>
        `;
        return;
    }
    ...
    tbody.innerHTML = shippers.map(shipper => `
        <tr class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                <div>Active: ${shipper.active_orders}</div>
                <div>Completed: ${shipper.completed_orders}</div>
            </td>
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                ${shipper.city || 'Not updated'}
            </td>
...
function editShipper(shipperId) {
    alert(`Edit shipper ID: ${shipperId}`);
    // Implementation will be added later
}
...
function exportShippers() {
    alert('Export list feature is under development');
}
</script>
@endsection