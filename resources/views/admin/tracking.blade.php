...
@section('title', 'Order Tracking Management - Admin')
...
@section('navigation')
    ...
    <a href="/admin/tracking" class="text-red-600 font-medium">Tracking</a>
...
@section('content')
    ...
    <div class="mb-8">
        <div class="bg-gradient-to-r from-purple-500 to-blue-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold mb-2">Order Tracking Management</h1>
                    <p class="text-purple-100">Track and manage all orders across the system</p>
                </div>
    ...
    <div class="bg-white shadow rounded-lg p-6 mb-6">
        <h3 class="text-lg font-medium text-gray-900 mb-4">Quick search</h3>
...
<script>
    ...
    function displayOrders(orders) {
        ...
        tbody.innerHTML = orders.map(order => `
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    ${order.shipper ? order.shipper.name : 'Unassigned'}<br>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    ${Number(order.total_fee || 0).toLocaleString('en-US')} ₫
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div class="flex space-x-2">
                        ...
                        <button onclick="editOrder('${order.id}')" class="text-green-600 hover:text-green-900" title="Edit">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button onclick="assignShipper('${order.id}')" class="text-purple-600 hover:text-purple-900" title="Assign">
                            <i class="fas fa-user-plus"></i>
                        </button>
                        <button onclick="updateStatus('${order.id}')" class="text-orange-600 hover:text-orange-900" title="Update status">
    ...
    function viewOrderDetails(orderId) {
        alert(`View order details ${orderId}. This feature will be developed!`);
    }
    
    function editOrder(orderId) {
        alert(`Edit order ${orderId}. This feature will be developed!`);
    }
